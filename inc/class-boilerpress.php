...
if ( ! class_exists( 'BoilerPress' ) ) :
    ...
    class BoilerPress {
        ...
        public function scripts() {
            ...
            wp_enqueue_script( 'boilerpress-js', get_template_directory_uri() . '/assets/js/main.js', array(
                'jquery',
                'boilerpress-plugins'
            ), '20151215', TRUE );
        ...
        public function body_classes( $classes ) {
            ...
            function filter_classes_array( $class = '' ) {
                if ( FALSE !== strpos( $class, 'page-template' ) ) {
                    return FALSE;
                }
                if ( FALSE !== strpos( $class, 'page-id' ) ) {
                    return FALSE;
                }
                if ( FALSE !== strpos( $class, 'postid' ) ) {
                    return FALSE;
                }
            ...
            if ( is_page() ) {
                ...
                if ( $template = get_page_template() ) {
                    $template_name =
                        isset( pathinfo( $template )[ 'filename' ] ) ? pathinfo( $template )[ 'filename' ] : '';
        ...
        public function navigation_markup_template() {
            $template =
                '<nav id="post-navigation" class="navigation %1$s" role="navigation" aria-label="Post Navigation">';
